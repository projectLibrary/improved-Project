...
returnBookPost = async (req, res, next) => {
    ...
    const booksIssued = await Issuedbooks.findOne(
        { where:
            { id:id}
        });
    ...
    const bookId=booksIssued.bookId;    
    const expectedreturnDate=booksIssued.expectedreturnDate;
